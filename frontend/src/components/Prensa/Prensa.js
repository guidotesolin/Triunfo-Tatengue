    ...
    return (
      <div id="DivPrensa">
        ...
        <Media>
          ...
          <Media.Body>
            ...
            <p>
              ...
              tiempos, ya que se transformó en la segunda fuerza política, con
              un claro cuestionamiento a la conducción de Luis Spahn en Unión y
              con un proyecto para reformar el estatuto del club.
            </p>
            ...
            {this.AnadidaHace(new Date("2020-06-03"))}
          </Media.Body>
        </Media>
        <hr />
        <Media>
          ...
          <Media.Body>
            ...
            <p>
              ...
              teníamos en vista para vender. Se vendió casi 7 millones de
              dolares en cuotas o de contado, que no sabemos, y se invirtió
              alrededor de 3 millones de dolares. No sabemos que pasó con esa
              diferencia de unos 4 millones de dolares"
            </p>
            <button class="BotonPrensa BotonNota EfectoBoton">
              <a
                rel="noopener noreferrer"
            ...
            {this.AnadidaHace(new Date("2020-06-01"))}
          </Media.Body>
        </Media>
        <hr />
        <Media>
          ...
          <Media.Body>
            ...
            <p>
              En primer termino recordó que hace un año Luis Spahn fue reelecto
              en las ultimas elecciones en la institución Tatengue: “Hoy se
              cumplen un año de las elecciones seguimos con un proyecto firme”
            </p>
            <button class="BotonPrensa BotonNota EfectoBoton">
              <a
                rel="noopener noreferrer"
        ...
        <Media>
          ...
          <Media.Body>
            <h4 id="TituloNoticia">
              "Unión no mejoró, viene pasos para atrás"
            </h4>
            <p id="Epigrafe">
        ...
        <Media>
          ...
          <Media.Body>
            ...
            <p>
              A un año de las ultimas elecciones en UNIÓN contamos novedades
              sobre los proyectos en los cuales estamos trabajando, entre los
              cuales destaca la propuesta para reformar el estatuto de nuestro
              querido club.
            </p>
            <button class="BotonPrensa BotonNota EfectoBoton">
              <a
        ...
        <Media>
          ...
          <Media.Body>
            ...
            <p id="Epigrafe">
              ...
              Spahn, anunció que presentará un proyecto para reformar el
              estatuto con innovaciones de fondo. También aprovechó para hacer
              críticas a la actual gestión.
            </p>
            <p>
              Triunfo Tatengue redobla la apuesta y a un año de las elecciones
              en las que resultó electo el actual presidente, Luis Spahn,
              formula críticas a la gestión y señala: “Pasó un año y estamos
              peor. Se vendió por mucho dinero, se desvalorizó el plantel, no se
              sabe si se achicó la deuda con los acreedores, especialmente con
              el presidente, no hubo obras y se fue la figura más importante que
              era nuestro técnico”, señala Leonardo Simonutti, el presidente de
              este grupo político que resultó segundo en las elecciones del 1 de
              junio pasado.
            </p>
            <button class="BotonPrensa BotonNota EfectoBoton">
              <a
            ...
            {this.AnadidaHace(new Date("2020-05-31"))}
          </Media.Body>
        </Media>
        ...
        <Media>
          ...
          <Media.Body>
            ...
            <p>
              ...
              elección en Unión. En los últimos comicios, Luis Spahn fue
              reelecto como presidente de la institución. A casi un año del acto
              electivo, Leonardo Simonutti, presidente de Triunfo Tatengue,
              charló con Nexo Diario sobre los proyectos que buscan realizar en
              el club.
            </p>
            <button class="BotonPrensa BotonNota EfectoBoton">
              <a
            ...
            {this.AnadidaHace(new Date("2020-05-30"))}
          </Media.Body>
        </Media>
        <hr />
      </div>
